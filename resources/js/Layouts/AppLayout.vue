<template>
    <div class="min-h-screen bg-gray-100">
        <nav class="bg-white border-b border-gray-100 bg-black">
            <!-- Primary Navigation Menu -->
            <div class="mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex">
                        <!-- Logo -->
                        <div class="flex-shrink-0 flex items-center text-2xl text-white">
                            <!--<inertia-link :href="route('dashboard')">
                                <jet-application-mark class="block h-9 w-auto" />
                            </inertia-link>-->
                            <a :href="route('home')">6thmen</a>
                        </div>

                        <!-- Navigation Links -->
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex ">

                            <jet-nav-link :href="route('pronostic')" :active="route().current('pronostic')">
                                Pronostique
                            </jet-nav-link>
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                <div class="py-2 space-y-1">
                    <jet-responsive-nav-link :href="route('pronostic')" :active="route().current('pronostic')">
                        Pronostique
